...
template <typename T, typename ConstructorKey, typename ConstructorKeyHash> class SocketSingleton {
public:
    template <typename... ConstructorArgs> static std::shared_ptr<T> create(ConstructorArgs &&..._args) {
