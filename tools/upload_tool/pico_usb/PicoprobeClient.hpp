...
class PicoprobeClient: public UploadTool::RP2040FlashInterface {
public:
...
class PicoprobeDevice: public UploadTool::RP2040Device {
public:
    ...
    std::shared_ptr<UploadTool::RP2040FlashInterface> getFlashInterface() override {return itf;}
