...
#include <mercury_msgs/msg/dshot_command.h>
#include <mercury_msgs/msg/dshot_partial_telemetry.h>
#include <mercury_msgs/msg/dshot_rpm_feedback.h>
...
mercury_msgs__msg__DshotCommand dshot_msg;
...
static void dshot_subscription_callback(const void *msgin) {
    const mercury_msgs__msg__DshotCommand *msg = (const mercury_msgs__msg__DshotCommand *) msgin;
...
rcl_ret_t ros_send_rpm(uint8_t board_id) {
    mercury_msgs__msg__DshotRPMFeedback rpm_msg = { 0 };
    mercury_msgs__msg__DshotRPMFeedback cmd_msg = { 0 };
...
rcl_ret_t ros_send_telemetry(uint8_t board_id) {
    mercury_msgs__msg__DshotPartialTelemetry telem_msg;
...
rcl_ret_t ros_init(uint8_t board_id) {
    ...
    RCRETCHECK(rclc_subscription_init_best_effort(&dshot_subscriber, &node,
                                                  ROSIDL_GET_MSG_TYPE_SUPPORT(mercury_msgs, msg, DshotCommand),
                                                  DSHOT_COMMAND_SUCRIBER_NAME));

    RCRETCHECK(rclc_publisher_init_best_effort(&dshot_rpm_publisher, &node,
                                               ROSIDL_GET_MSG_TYPE_SUPPORT(mercury_msgs, msg, DshotRPMFeedback),
    ...
    RCRETCHECK(rclc_publisher_init_best_effort(&dshot_telem_publisher, &node,
                                               ROSIDL_GET_MSG_TYPE_SUPPORT(mercury_msgs, msg, DshotPartialTelemetry),
