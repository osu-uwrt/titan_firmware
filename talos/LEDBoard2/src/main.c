...
#define LEDC_WATCHDOG_TIME_MS 50
...
absolute_time_t ledc_watchdog_timer = { 0 };
...
static void tick_background_tasks() {
    ...
    if (timer_ready(&ledc_watchdog_timer, LEDC_WATCHDOG_TIME_MS, false)) {
        pet_watchdog();
    }
}
...
// Initialize stdio
    ...
    init_hardware();  // ledc specific
    ledc_init();      // put somewhere else
