...
#define FAULT_ACTUATOR_FAILURE                                                                                         \
    5  // Raised if an actuator command could not successfully due to a hardware/firmware issue
...
static const char *const fault_string_list[] = { "FAULT_WATCHDOG_RESET",     "FAULT_WATCHDOG_WARNING",
                                                 ...
                                                 "FAULT_TIMER_MISSED",       "FAULT_ACTUATOR_FAILURE",
