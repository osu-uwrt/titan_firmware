...
/**
 * @brief Decodes the received EEPROM response from a packet generated with `dynamixel_reg_eeprom_gen_request` into the
 * eeprom buffer.
 *
...
/**
 * @brief Decodes the received RAM response from a packet generated with `dynamixel_reg_ram_gen_request` into the ram
 * buffer.
 *
 * @param response The response to decode
