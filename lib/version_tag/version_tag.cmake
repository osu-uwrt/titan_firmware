...
function(generate_version_tag target major_version minor_version)
    ...
    ADD_CUSTOM_COMMAND(
        ...
        COMMAND ${CMAKE_COMMAND} -DMAJOR_VERSION=${major_version} -DMINOR_VERSION=${minor_version} -DBOARD=${PICO_BOARD} 
