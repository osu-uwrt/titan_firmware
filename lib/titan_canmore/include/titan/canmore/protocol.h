#ifndef TITAN__CANMORE__PROTOCOL_H_
#define TITAN__CANMORE__PROTOCOL_H_
...
#define CANMORE_TITAN_CONTROL_INTERFACE_MODE_LINUX 0b011u
...
#define CANMORE_TITAN_HEARTBEAT_TERM_VALID_OFFSET                                                                      \
    (CANMORE_TITAN_HEARTBEAT_MODE_OFFSET + CANMORE_TITAN_HEARTBEAT_MODE_LENGTH)
#define CANMORE_TITAN_HEARTBEAT_TERM_ENABLED_OFFSET                                                                    \
    (CANMORE_TITAN_HEARTBEAT_TERM_VALID_OFFSET + CANMORE_TITAN_HEARTBEAT_TERM_VALID_LENGTH)
...
#define CANMORE_CALC_TITAN_HEARTBEAT_DATA(cnt, error, mode, term_valid, term_enabled)                                  \
    ((((cnt) & ((1u << CANMORE_HEARTBEAT_CNT_LENGTH) - 1u)) << CANMORE_HEARTBEAT_CNT_OFFSET) |                         \
     ...
     (((term_valid) & ((1u << CANMORE_TITAN_HEARTBEAT_TERM_VALID_LENGTH) - 1u))                                        \
      << CANMORE_TITAN_HEARTBEAT_TERM_VALID_OFFSET) |                                                                  \
     (((term_enabled) & ((1u << CANMORE_TITAN_HEARTBEAT_TERM_ENABLED_LENGTH) - 1u))                                    \
      << CANMORE_TITAN_HEARTBEAT_TERM_ENABLED_OFFSET))
