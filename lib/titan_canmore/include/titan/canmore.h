#ifndef TITAN__CANMORE_H_
#define TITAN__CANMORE_H_

/**
 * @file titan/canmore.h
 *
 * @brief Library containing CANmore protocol definitions and functions to allow for writing applications to communicate
 * using the CANmore protocol.
 *
 */
