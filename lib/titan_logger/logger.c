...
void titan_logger_set_global_log_level(int log_level) {
    dynamic_global_log_level = log_level;
}

void titan_logger_set_custom_logger_callback(custom_logger_cb_t callback, void* args) {
...
void titan_logger_remove_custom_logger_callback(custom_logger_cb_t callback) {
...
void titan_logger_log_common(const int log_level, const int local_log_level, const char * unit, const char * filename, const int line, const char * const function, const char * const fmt, ...) {
