...
#define ESC4_PWM_PIN 5
#define ESC4_TELEM_PIN 4
#define ESC3_PWM_PIN 3
#define ESC3_TELEM_PIN 2
#define ESC2_PWM_PIN 7
#define ESC2_TELEM_PIN 6
#define ESC1_PWM_PIN 1
#define ESC1_TELEM_PIN 0
