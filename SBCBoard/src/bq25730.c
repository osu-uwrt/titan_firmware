...
static void bq25730_on_i2c_failure(const struct async_i2c_request *, uint32_t) {
    printf("oh oh\n");
}

static void bq25730_on_i2c_req_complete(const struct async_i2c_request *, uint32_t) {
...
void bq25730_init(unsigned int busNum) {
    ...
    i2c_req.bytes_to_receive = NULL;
    i2c_req.bytes_to_send = NULL;
